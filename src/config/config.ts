...
export const config = {
  // Server
  port: parseInt(process.env.PORT || '3005', 10), // AI Agent port
  ...
  postgres: {
    ...
    database: process.env.POSTGRES_DB || 'lazarus_ai_agent',
  ...
  cosmosdb: {
    uri: process.env.COSMOSDB_URI || process.env.MONGODB_URI || 'mongodb://localhost:27017/lazarus_ai_agent_read',
